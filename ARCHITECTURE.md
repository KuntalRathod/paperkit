...
**Project codename:** `paperkit` (or replace with your chosen domain name throughout)
    ...
    <header className="sticky top-0 z-50 border-b border-zinc-100 bg-white/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-zinc-900">paperkit</span>
        </Link>
...
export const metadata: Metadata = {
  title: 'Merge PDF Free — No Watermark, No Upload | Paperkit',
  ...
  openGraph: {
    title: 'Merge PDF Free — No Watermark | Paperkit',
    description: '...',
    type: 'website',
  }
}
