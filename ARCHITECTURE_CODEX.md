...
4. Set up app/layout.tsx with:
   ...
   - metadata: title "Paperkit — Free PDF Tools, No Watermark", description "46 free PDF tools. No watermark. No upload. No sign-up. Files never leave your device."
   - Import globals.css
...
2. components/layout/Navbar.tsx
   ...
   - Left: small square logo div (h-6 w-6 rounded-[6px] bg-[#2563EB]) + "paperkit" text-sm font-semibold
...
3. components/layout/Footer.tsx
   ...
   - "© 2025 paperkit · Free PDF tools, forever · Files never leave your device"
...
2. app/(tools)/merge-pdf/page.tsx
   metadata: title "Merge PDF Free — No Watermark | Paperkit", description "Combine multiple PDF files into one. No watermark, no upload, no sign-up."
...
3. app/(tools)/split-pdf/page.tsx
   metadata: title "Split PDF Free — Extract Pages | Paperkit"
...
4. app/(tools)/compress-pdf/page.tsx
   metadata: title "Compress PDF Free — Reduce File Size | Paperkit"
   Tool: single file upload
...
5. app/(tools)/rotate-pdf/page.tsx
   metadata: title "Rotate PDF Free | Paperkit"
   Tool: single file upload
...
6. app/(tools)/pdf-to-jpg/page.tsx
   metadata: title "PDF to JPG Free — No Watermark | Paperkit"
   Tool: single file upload
...
7. app/(tools)/jpg-to-pdf/page.tsx
   metadata: title "Images to PDF Free | Paperkit"
...
3. SEO metadata for every tool page
   Pattern: title "[Tool Name] Free — No Watermark | Paperkit", description one sentence about what it does + "No watermark, no upload, no sign-up."
