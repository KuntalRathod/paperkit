      ...
      <div className="relative z-10 mx-auto max-w-5xl">
          ...
          >
            {(toolFeaturesMap[pathname.slice(1)] || defaultFeatures).map((feature, idx) => (
              ...
              >
                 ...
                 <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-text-muted/30 z-10 transition-colors group-hover:border-[#14b8a6]/50" />
                 <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-text-muted/30 z-10 transition-colors group-hover:border-[#14b8a6]/50" />
                 
                 {/* Soft glow on hover */}
                 <div className="absolute inset-0 bg-gradient-to-br from-[#14b8a6]/0 via-transparent to-[#14b8a6]/0 group-hover:from-[#14b8a6]/10 group-hover:to-transparent transition-all duration-700 z-0" />
                 
                 <div className="flex items-center gap-3 mb-3 z-10">
                   <div className="h-1.5 w-1.5 bg-text-primary/20 rounded-none group-hover:bg-[#14b8a6] group-hover:shadow-[0_0_12px_rgba(20,184,166,0.8)] transition-all duration-300" />
        ...
        {pathname === '/' && (
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] sm:w-[80%] sm:h-[80%] bg-gradient-to-tr from-[#14b8a6]/15 via-transparent to-[#14b8a6]/5 blur-[60px] sm:blur-[100px] rounded-[100%] pointer-events-none z-0"
            />
            ...
            >
              <Link 
                href="/merge-pdf" 
                className="group relative inline-flex items-center justify-center overflow-hidden bg-transparent border border-[#14b8a6] px-8 py-3.5 font-mono text-xs uppercase tracking-widest text-text-primary transition-all active:scale-95 hover:shadow-[0_0_20px_rgba(20,184,166,0.15)]"
              >
                ...
                <div className="absolute inset-0 z-0 h-full w-0 bg-[#14b8a6] transition-all duration-300 ease-out group-hover:w-full" />
              </Link>
            </motion.div>
          </motion.div>
          </>
        ...
        >
          ...
          <div className="p-6 md:col-span-1 border-b md:border-b-0 border-dashed border-border/80 md:border-r flex flex-col justify-between">
            <Link href="/" className="flex items-center gap-0 -ml-2" aria-label="Paperkit home">
              <BrandLogo className="h-15 w-20 opacity-80" />
              <span className="hero-display text-xl text-text-primary font-black -ml-5 tracking-tight ">Paperkit</span>
            </Link>
            <div className="mt-8">
          ...
          <div className="grid grid-cols-2 md:col-span-3">
            ...
            <div className="p-3 sm:p-6 flex flex-col justify-between">
              <div className="flex flex-col gap-2 sm:gap-3 mono-copy text-[9px] sm:text-xs uppercase tracking-wider">
                 ...
                 <span title="Coming soon" className="w-fit cursor-default text-text-muted/70">
                    Contact <span className="text-[8px] sm:text-[10px] text-text-primary/40">(Coming soon)</span>
                 </span>
              </div>
              
              <div className="flex items-center gap-2 mt-4 sm:mt-8">
                <a href="https://www.linkedin.com/in/kuntalrathod/" target="_blank" rel="noopener noreferrer" className="flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center border border-border text-text-muted transition-all hover:border-text-primary hover:text-text-primary bg-bg-elevated/30" aria-label="LinkedIn">
                ...
                <a href="https://x.com/kuntalrathod77" target="_blank" rel="noopener noreferrer" className="flex h-6 w-6 sm:h-8 sm:w-8 items-center justify-center border border-border text-text-muted transition-all hover:border-text-primary hover:text-text-primary bg-bg-elevated/30" aria-label="Twitter">
        ...
        <div className="relative border-x border-b border-dashed border-border/80 px-6 py-4 flex flex-col items-center justify-between gap-3 text-[10px] uppercase tracking-widest text-text-muted/60 sm:flex-row bg-bg-base mono-copy">
          <div>
            &copy; {new Date().getFullYear()} PAPERKIT. ALL RIGHTS RESERVED.
          </div>  
          
          <div className="flex items-center gap-2">
             <div className="h-1 w-1 bg-text-primary/40" />
             <span title="Personal site coming soon" className="text-text-primary font-medium cursor-default" >ENGINEERED BY KUNTAL</span>
          </div>
        </div>
      </div>
    </footer>
